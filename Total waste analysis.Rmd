...
##Missing data check
The data set was checked for missing values through..
```{r}
##The data set had missing values and it was taken care of using the function..
Land_Fill <- na.omit(Land_Fill)
##And hence the data set was clean from missing values
colSums(is.na(Land_Fill))
```
